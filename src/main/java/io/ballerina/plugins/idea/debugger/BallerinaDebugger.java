...
//            return 8081;
    ...
    protected RunContentDescriptor doExecute(@NotNull RunProfileState state, @NotNull ExecutionEnvironment env)
        ...
        BallerinaApplicationRunningState applicationRunningState = (BallerinaApplicationRunningState) state;
        applicationRunningState.enableDebugging();
        int port = findFreePort();
        applicationRunningState.setPort(port);
        ...
        return XDebuggerManager.getInstance(env.getProject()).startSession(env, new XDebugProcessStarter() {
            ...
            public XDebugProcess start(@NotNull XDebugSession session) throws ExecutionException {
                ...
                String entryFilePath = applicationRunningState.getScript();
                ...
                BallerinaDebugProcess process = new BallerinaDebugProcess(session, ballerinaDebugSession,
                        getExecutionResults(applicationRunningState, env));
