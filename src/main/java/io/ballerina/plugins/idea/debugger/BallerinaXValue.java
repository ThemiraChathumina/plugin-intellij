...
public class BallerinaXValue extends XNamedValue {
    ...
    private static PsiElement findTargetElement(@NotNull Project project, @NotNull XSourcePosition position,
        ...
        PsiElement [] elements = PsiTreeUtil.collectElements(psiFile,
                psiElement -> psiElement.getNode().getElementType() == BallerinaTypes.IDENTIFIER_TOKEN
                        && Objects.equals(psiElement.getText(), name)
                        && range.contains(psiElement.getTextRange()));
