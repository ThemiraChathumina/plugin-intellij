...
public class BallerinaDebugProcess extends XDebugProcess {
    ...
    public void initDebugSession() {
        ...
        if (dapClientConnector.isConnected()) {
            ...
            isConnected = true;
            System.out.println("Connected nnknnkn");
            startDebugSession();
            return;
        }
        ...
        while (!isConnected && (++retryAttempt[0] <= MAX_RETRY_COUNT)) {
            ...
            if (!dapClientConnector.isConnected()) {
                ...
                System.out.println(dapClientConnector.isConnected());
                if (dapClientConnector.isConnected()) {
                    isConnected = true;
                    if (isRemoteDebugMode) {
                ...
                LOGGER.debug("Connection is already created.");
                isConnected = true;
                System.out.println("Connected fffff");
                startDebugSession();
                break;
            }
        }
    ...
    private void startDebugSession() {
        ...
        System.out.println("Breakpoints sent.");
    }
